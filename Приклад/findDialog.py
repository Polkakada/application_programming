...
# Form implementation generated from reading ui file 'D:\findDialog.ui'
#
...
class Ui_FindDialog(object):
    def setupUi(self, FindDialog):
        ...
        self.nameEdit = QtWidgets.QLineEdit(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.labelSource = QtWidgets.QLabel(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.sourceEdit = QtWidgets.QLineEdit(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.labelGenre = QtWidgets.QLabel(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.genreEdit = QtWidgets.QLineEdit(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.labelCountry = QtWidgets.QLabel(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.countryEdit = QtWidgets.QLineEdit(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.labelNickname = QtWidgets.QLabel(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.nicknameEdit = QtWidgets.QLineEdit(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.labelAuthorName = QtWidgets.QLabel(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.authorNameEdit = QtWidgets.QLineEdit(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.labelbirthday = QtWidgets.QLabel(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.birthdayEdit = QtWidgets.QDateEdit(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.labelSex = QtWidgets.QLabel(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.sexEdit = QtWidgets.QLineEdit(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.findFormButton = QtWidgets.QPushButton(FindDialog)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.findFormButton.setFont(font)
        self.findFormButton.setObjectName("findFormButton")
        self.formLayout.setWidget(15, QtWidgets.QFormLayout.SpanningRole, self.findFormButton)
        self.infoLabel = QtWidgets.QLabel(FindDialog)
        font = QtGui.QFont()
    ...
    def retranslateUi(self, FindDialog):
        ...
        FindDialog.setWindowTitle(_translate("FindDialog", "Поиск"))
        self.labelName.setText(_translate("FindDialog", "Название видео"))
        self.labelSource.setText(_translate("FindDialog", "Ссылка на видео"))
        self.labelGenre.setText(_translate("FindDialog", "Жанр видео"))
        self.labelCountry.setText(_translate("FindDialog", "Страна создания"))
        self.labelNickname.setText(_translate("FindDialog", "Псведоним автора"))
        self.labelAuthorName.setText(_translate("FindDialog", "Настоящее имя автора"))
        self.labelbirthday.setText(_translate("FindDialog", "День рождения автора"))
        self.labelSex.setText(_translate("FindDialog", "Пол автора"))
        self.findFormButton.setText(_translate("FindDialog", "Найти видео"))
